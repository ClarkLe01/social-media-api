...
urlpatterns = [
    ...
    path(
        "/room/members/<int:roomId>",
        MembersDetailListView.as_view(),
        name="members_detail",
    ),
    ...
    path(
        "/message/latest/<int:roomId>",
        LatestMessageRetrieveView.as_view(),
        name="last_message",
    ),
    ...
    path(
        "/message/seen/<int:messageId>",
        SeenMessageListView.as_view(),
        name="seen_message",
    ),
