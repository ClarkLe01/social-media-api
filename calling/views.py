...
class CreateMeetingAPIView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            data = {
                "autoCloseConfig": {"type": "session-end-and-deactivate", "duration": 60},
            }
            ...
            return Response(
                {"error": "RoomChat does not exist"}, status=status.HTTP_404_NOT_FOUND
            )
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            async_to_sync(channel_layer.group_send)(
                ...
                {"type": "endCall", "value": CallSerializer(call, many=False).data},
            )
            ...
            return Response(
                data={"statusCode": status.HTTP_200_OK, "message": "Ok"},
...
class GetRoomAPIView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        headers = {"Authorization": token, "Content-Type": "application/json"}
        res = requests.get(
            settings.VIDEOSDK_API_ENDPOINT + "/v2/rooms/" + roomId, headers=headers
        )
        return Response(data=res.json(), status=res.status_code)
...
class AccpetCallAPIView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            async_to_sync(channel_layer.group_send)(
                f"roomCall_{call.roomId}",
                {"type": "acceptCall", "value": CallSerializer(call, many=False).data},
            )
            return Response(
                data={"statusCode": status.HTTP_200_OK, "message": "Ok"},
                status=status.HTTP_200_OK,
...
class RejectCallAPIView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            async_to_sync(channel_layer.group_send)(
                f"roomCall_{call.roomId}",
                {"type": "rejectCall", "value": CallSerializer(call, many=False).data},
            )
            return Response(
                data={"statusCode": status.HTTP_200_OK, "message": "Ok"},
                status=status.HTTP_200_OK,
